...
from dtcs.twin.solution_system import xps
...
rsys = RxnSystem(
    ...
    RevRxn(o_star_threef + o_star, s + s_threefold, 0.00096, 76.964514),
...
r.plot_evolution(path=TEST_FIGURES_DIRECTORY,
                 title=f"trajectory_h2o_ag_{date_str}_unlimited_gas_bulk",
