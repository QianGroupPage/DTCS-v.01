...
results = scrn_simulate(rsys, 1E-4, video=False, spectra_in_video=True, spectra_average_duration=3, ensemble_size=1,
                        save_trajectory=True, trajectory_path="habor_bosch_limit_gas", compress_trajectory=True,
                        section_length=5E5)
