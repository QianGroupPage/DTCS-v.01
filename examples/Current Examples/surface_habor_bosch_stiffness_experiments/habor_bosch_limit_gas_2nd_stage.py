...
Assume the system has achieved relative stability after 1E-5s. Fast diffusion rates are scaled by 2 to 4 orders of
magnitudes.
"""
...
results = scrn_simulate(rsys, 200, video=False, spectra_in_video=True, spectra_average_duration=3, ensemble_size=1,
                        save_trajectory=True, trajectory_path="habor_bosch_limit_gas_2nd_stage", compress_trajectory=True,
                        section_length=5E5)
