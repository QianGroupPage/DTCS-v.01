...
Assume the surface becomes almost filled during the first stage. Fast diffusion rates are scaled by 4 to 6 orders of
magnitudes.
"""
...
results = scrn_simulate(rsys, 200, video=False, spectra_in_video=True, spectra_average_duration=3, ensemble_size=1,
                        save_trajectory=True, trajectory_path="habor_bosch_2nd_stage_slower_diffusion", compress_trajectory=True,
                        section_length=5E5)
