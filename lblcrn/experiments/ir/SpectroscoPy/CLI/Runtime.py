# lblcrn.SpectroscoPy/CLI/Runtime.py
...
from lblcrn.experiments.ir.SpectroscoPy.IR import CalculateIRIntensity;
from lblcrn.experiments.ir.SpectroscoPy.Raman import GenerateDisplacedStructures, CalculateRamanActivityTensor, ScalarAverageRamanActivityTensor;
from lblcrn.experiments.ir.SpectroscoPy.Spectrum import SimulateSpectrum;

from lblcrn.experiments.ir.SpectroscoPy.TextExport import GroupForPeakTable, SavePeakTable, SaveSpectrum;
from lblcrn.experiments.ir.SpectroscoPy.YAMLExport import SaveRamanTensors;
from lblcrn.experiments.ir.SpectroscoPy.Plotting import PlotSpectrum;

from lblcrn.experiments.ir.SpectroscoPy.Constants import GetFrequencyUnitLabel;
from lblcrn.experiments.ir.SpectroscoPy.Utilities import CalculateCellVolume, ConvertFrequencyUnits;

from lblcrn.experiments.ir.SpectroscoPy.CLI.IntermediateIO import ReadRamanDataSet, WriteRamanDataSet;
...
def RunMode_Output(spectrumType, frequencies, frequencyUnits, intensities, intensityUnits, args, linewidths = None, irRepData = None):
    ...
    # Most of the functions called from the other lblcrn.SpectroscoPy modules have their own error-handling, and we defer to those where possible to reduce "boilerplate" code.
