...
from dtcs.fire.firetasks.glue_tasks import ForwardCoreEigen, ForwardSimConcs
from dtcs.fire.fireworks.xps import XPSSimulateFW
from dtcs.fire.fireworks.crn import CRNSimulateFW
...
def _get_fws_ir_species(
    ...
    fw_ir_spectrum = Firework(
        tasks=[
            ...
            PyTask(func='dtcs.sim.ir.wrapper.ir_sim_wrapper'),
