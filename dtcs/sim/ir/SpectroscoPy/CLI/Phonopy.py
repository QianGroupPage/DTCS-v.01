# dtcs.SpectroscoPy/CLI/Phonopy.py
...
from dtcs.sim.ir import ReadPhonopyYAML, ReadMeshYAML, ReadIrRepsYAML, ReadMeshHDF5, ReadPhono3pyHDF5;
from dtcs.sim.ir.SpectroscoPy.Interfaces.VASP import ReadPOSCAR;
