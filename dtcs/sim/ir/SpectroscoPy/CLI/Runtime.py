# dtcs.SpectroscoPy/CLI/Runtime.py
...
from dtcs.sim.ir.SpectroscoPy.IR import CalculateIRIntensity;
from dtcs.sim.ir.SpectroscoPy.Raman import GenerateDisplacedStructures, CalculateRamanActivityTensor, ScalarAverageRamanActivityTensor;
from dtcs.sim.ir import SimulateSpectrum;

from dtcs.sim.ir import GroupForPeakTable, SavePeakTable, SaveSpectrum;
from dtcs.sim.ir import SaveRamanTensors;
from dtcs.sim.ir.SpectroscoPy.Plotting import PlotSpectrum;

from dtcs.sim.ir import CalculateCellVolume, ConvertFrequencyUnits;

from dtcs.sim.ir import ReadRamanDataSet, WriteRamanDataSet;
...
def RunMode_Output(spectrumType, frequencies, frequencyUnits, intensities, intensityUnits, args, linewidths = None, irRepData = None):
    ...
    # Most of the functions called from the other dtcs.SpectroscoPy modules have their own error-handling, and we defer to those where possible to reduce "boilerplate" code.
