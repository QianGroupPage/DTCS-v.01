...
from dtcs.spec.crn.surface.api_adapt import (
    generate_manifest_stream, generate_surface)
from dtcs.sim.surface_crn.hex_grid_with_intersect import HexGridPlusIntersectionDisplay
from dtcs.sim.surface_crn.ensemble import Ensemble
from dtcs.sim.surface_crn.results import Results
from dtcs.sim.surface_crn.surface_crns import SurfaceCRNQueueSimulator
...
from dtcs.sim.surface_crn.surface_crns.readers.manifest_readers import \
    read_manifest
...
def scrn_simulate(rxns,
    ...
    if save_trajectory:
        ...
        # Even if trajectory_path is provided, check if it overwrites an existing directory.
            ...
            pass # TODO: modify the prompts in resolve_video
